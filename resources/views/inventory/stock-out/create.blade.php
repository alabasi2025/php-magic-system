...
@section('title', 'إنشاء أمر صرف مخزني')
...
<div class="container-fluid" dir="rtl">
    ...
    <div class="create-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('inventory.stock-out.index') }}" class="btn btn-light">
    ...
    {{-- Form --}}
    <form action="{{ route('inventory.stock-out.store') }}" method="POST" id="stockInForm">
        @csrf
        ...
        <div class="form-card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label">
                            ...
                            تاريخ الصرف <span class="text-danger">*</span>
                        </label>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" value="{{ $nextNumber }}" readonly style="background: #f1f5f9; font-weight: 700; color: #11998e;">
                    </div>
                    ...
                    <table class="items-table">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 12%;">تكلفة الوحدة <span class="text-danger">*</span></th>
                            ...
                            <tr class="item-row">
                                ...
                                <td>
                                    <input type="text" class="form-control form-control-sm item-total" 
                                           readonly style="background: #f1f5f9; font-weight: 700; color: #11998e;">
                                </td>
                                <td>
                                    <input type="text" name="items[0][batch_number]" class="form-control form-control-sm" placeholder="اختياري">
                                </td>
                                <td>
            ...
            <div class="form-section">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('inventory.stock-out.index') }}" class="btn btn-cancel">
...
function addItem() {
    ...
    newRow.innerHTML = `
        ...
        <td>
            <input type="text" name="items[${itemIndex}][batch_number]" class="form-control form-control-sm" placeholder="اختياري">
        </td>
        <td>
...
document.getElementById('stockInForm').addEventListener('submit', function(e) {
    ...
    // Check if all items have quantity and cost
    let isValid = true;
    rows.forEach(row => {
        const quantity = parseFloat(row.querySelector('.item-quantity').value) || 0;
        const cost = parseFloat(row.querySelector('.item-cost').value) || 0;
