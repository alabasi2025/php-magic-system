    ...
    <div class="card border-0 shadow-lg mb-4" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 20px;">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('inventory.stock-in.index') }}" class="btn btn-light btn-lg rounded-pill px-4">
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="info-item">
                                ...
                                <div class="fw-bold fs-5">{{ $stockIn->movement_number }}</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="info-item">
                        ...
                        <div class="col-md-6">
                            <div class="info-item">
                                <label class="text-muted small mb-1">تاريخ التوريد</label>
                                <div class="fw-bold">
                        ...
                        <div class="col-12">
                            <div class="info-item">
                                ...
                                <div class="alert alert-light border">{{ $stockIn->notes }}</div>
                            </div>
                        </div>
                        @endif
                    </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tfoot style="background-color: #f8f9fa;">
                                <tr>
                                    ...
                                    <th class="text-success fs-5">{{ number_format($stockIn->items->sum('total_cost'), 2) }} ريال</th>
                                    <th colspan="2"></th>
                                </tr>
                            </tfoot>
                        </table>
                ...
                <div class="card-body text-center">
                    ...
                    @elseif($stockIn->status === 'approved')
                        ...
                        <div class="mt-3">
                            ...
                            <div class="fw-bold">{{ $stockIn->approver->name }}</div>
                            <small class="text-muted">{{ $stockIn->approved_at ? \Carbon\Carbon::parse($stockIn->approved_at)->format('Y-m-d H:i') : '' }}</small>
                        </div>
                        @endif
            ...
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        @if($stockIn->status === 'pending')
                            <a href="{{ route('inventory.stock-in.edit', $stockIn->id) }}" class="btn btn-primary btn-lg rounded-pill">
                        ...
                        @endif
                        <a href="{{ route('inventory.stock-in.index') }}" class="btn btn-outline-secondary btn-lg rounded-pill">
                            <i class="fas fa-arrow-right me-2"></i>
                            العودة للقائمة
                        </a>
                    </div>
