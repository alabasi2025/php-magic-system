...
<div class="container-fluid" dir="rtl">
    ...
    <div class="create-header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('inventory.stock-in.index') }}" class="btn btn-light">
    ...
    {{-- Form --}}
    <form action="{{ route('inventory.stock-in.store') }}" method="POST" id="stockInForm">
        @csrf
        ...
        <div class="form-card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label">
                            ...
                            تاريخ التوريد <span class="text-danger">*</span>
                        </label>
            ...
            <div class="form-section">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('inventory.stock-in.index') }}" class="btn btn-cancel">
