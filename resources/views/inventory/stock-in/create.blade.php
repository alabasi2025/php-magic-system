...
<div class="create-page">
    <div class="container">
        <form action="{{ route('inventory.stock-in.store') }}" method="POST" class="glass-form" data-aos="fade-up">
            @csrf
            
            <!-- Form Header -->
            <div class="form-header">
                <h1><i class="fas fa-box-open"></i> إنشاء أمر توريد مخزني</h1>
                <p>قم بإدخال بيانات التوريد والأصناف المراد إضافتها للمخزن</p>
            </div>
            ...
            <div class="form-body">
                ...
                <div class="form-section" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">تاريخ التوريد <span class="text-danger">*</span></label>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('inventory.stock-in.index') }}" class="btn-cancel">
