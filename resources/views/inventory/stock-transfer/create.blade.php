...
<div class="create-page">
    <div class="container">
        <form action="{{ route('inventory.stock-transfer.store') }}" method="POST" class="glass-form" data-aos="fade-up">
            @csrf
            
            <!-- Form Header -->
            <div class="form-header">
                <h1><i class="fas fa-box-open"></i> إنشاء أمر توريد مخزني</h1>
                <p>قم بإدخال بيانات التحويل والأصناف المراد إضافتها للمخزن</p>
            </div>
            ...
            <div class="form-actions">
                ...
                <a href="{{ route('inventory.stock-transfer.index') }}" class="btn-cancel">
