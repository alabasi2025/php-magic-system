    ...
    <div class="row mb-4">
        <div class="col-md-12">
            ...
            <div class="d-flex align-items-center">
                <div style="width: 60px; height: 60px; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 15px; display: flex; align-items: center; justify-content: center; margin-left: 15px;">
                    <i class="fas fa-warehouse fa-2x text-white"></i>
                </div>
                <div>
                    <h2 class="mb-1">إضافة مخزن جديد</h2>
                    <p class="text-muted mb-0">أضف مخزن جديد إلى النظام</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <form action="{{ route('inventory.warehouses.store') }}" method="POST">
                    ...
                    <div class="form-group-enhanced">
                        ...
                        <select class="form-control-enhanced @error('warehouse_group_id') is-invalid @enderror" 
                            ...
                            @foreach($warehouseGroups as $group)
                                <option value="{{ $group->id }}" {{ old('warehouse_group_id') == $group->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group-enhanced">
                        ...
                        <textarea class="form-control-enhanced @error('description') is-invalid @enderror" 
                                  ...
                                  name="description" 
                                  rows="4"
                                  placeholder="أضف وصفاً تفصيلياً للمخزن...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback d-block">
                                <i class="fas fa-exclamation-circle me-1"></i>
                                {{ $message }}
