    ...
    <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-blue-100 mt-2 text-lg">مرحباً بك في نظام SEMOP لإدارة المؤسسات - الإصدار 2.6.0</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="h-64 flex items-end justify-between space-x-2 space-x-reverse">
                ...
                <div class="flex-1 bg-gradient-to-t from-blue-500 to-blue-400 rounded-t-lg hover:from-blue-600 hover:to-blue-500 transition-all duration-200" style="height: 100%;" title="الأحد: 60,000 ريال"></div>
                <div class="flex-1 bg-gradient-to-t from-blue-500 to-blue-400 rounded-t-lg hover:from-blue-600 hover:to-blue-500 transition-all duration-200" style="height: 100%;" title="الاثنين: 38,000 ريال"></div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
                    ...
                    <span class="font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">v2.6.0</span>
                </div>
                ...
                <div class="p-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg text-white">
                    ...
                    <p class="text-3xl font-bold">1482</p>
                ...
                <div class="p-4 bg-gradient-to-r from-green-500 to-teal-500 rounded-lg text-white">
                    ...
                    <p class="text-xs mt-1 text-green-100">2000 من 2000 مهمة</p>
                </div>
            </div>
        </div>
    </div>
