...
@section('title', 'إدارة الأصول - SEMOP')

@section('content')
<div class="space-y-6">
    <!-- Page Header -->
    <div class="bg-gradient-to-r from-gray-600 to-gray-700 rounded-lg shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4 space-x-reverse">
                ...
                <div>
                    <h1 class="text-4xl font-bold">إدارة الأصول</h1>
                    <p class="text-gray-100 mt-2">إدارة شاملة ومتقدمة</p>
                </div>
            </div>
            <button class="bg-white text-gray-600 px-6 py-3 rounded-lg font-bold hover:bg-gray-50 transition-colors">
    ...
    <div class="bg-white rounded-lg shadow-lg p-4">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center space-x-4 space-x-reverse">
                <div class="relative">
                    <input type="text" placeholder="بحث..." class="pr-10 pl-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-500 focus:border-transparent">
