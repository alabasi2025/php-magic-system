...
@section('title', 'الإشعارات - SEMOP')

@section('content')
<div class="space-y-6">
    <!-- Page Header -->
    <div class="bg-gradient-to-r from-yellow-600 to-yellow-700 rounded-lg shadow-lg p-6 text-white">
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4 space-x-reverse">
                ...
                <div>
                    <h1 class="text-4xl font-bold">الإشعارات</h1>
                    <p class="text-yellow-100 mt-2">إدارة شاملة ومتقدمة</p>
                </div>
            </div>
            <button class="bg-white text-yellow-600 px-6 py-3 rounded-lg font-bold hover:bg-yellow-50 transition-colors">
    ...
    <div class="bg-white rounded-lg shadow-lg p-4">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div class="flex items-center space-x-4 space-x-reverse">
                <div class="relative">
                    <input type="text" placeholder="بحث..." class="pr-10 pl-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent">
                    <i class="fas fa-search absolute right-3 top-3 text-gray-400"></i>
                </div>
                <select class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500">
                    <option>الكل</option>
                    <option>نشط</option>
                    <option>معلق</option>
    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-gray-50 px-6 py-4 flex items-center justify-between border-t">
            ...
            <div class="flex items-center space-x-2 space-x-reverse">
                ...
                <button class="px-4 py-2 bg-yellow-600 text-white rounded-lg">1</button>
