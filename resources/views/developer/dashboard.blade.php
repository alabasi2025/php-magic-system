    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <!-- Database Designer -->
                <a href="{{ route('developer.ai.database-optimizer') }}" class="group">
        ...
        <div class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <!-- Bug Fixer -->
                <a href="{{ route('developer.ai.bug-detector') }}" class="group">
                ...
                <a href="{{ route('developer.ai.documentation-generator') }}" class="group">
