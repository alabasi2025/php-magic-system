...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <h1><i class="fas fa-plus-circle"></i> إنشاء أمر شراء جديد</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">إنشاء أمر جديد</li>
                </ol>
            </nav>
        </div>
    </div>

    <form action="{{ route('purchases.orders.store') }}" method="POST">
        @csrf
                                    ...
                                    <tr class="item-row">
                                        <td>
                                            <select class="form-select form-select-sm item-select" name="items[0][product_id]" required>
                                                ...
                                                <!-- سيتم تعبئة الأصناف من قاعدة البيانات -->
                                            </select>
                                        </td>
                                        <td>
                ...
                <div class="card mb-4 sticky-top" style="top: 20px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <strong class="h5 text-primary" id="grand-total">0.00</strong>
                        </div>
