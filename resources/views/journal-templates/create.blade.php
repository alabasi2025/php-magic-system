...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2 mr-16">قم بإنشاء قالب جاهز للقيود المحاسبية المتكررة</p>
                </div>
        ...
        <form action="{{ route('journal-templates.store') }}" method="POST" id="templateForm">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                                  class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-300"
                                  placeholder="وصف مختصر للقالب وكيفية استخدامه..."></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6">
                <div class="flex gap-4 justify-end">
                    ...
                    <button type="submit" 
                            class="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white px-8 py-3 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2">
        ...
        <div class="entry-row bg-gray-50 rounded-xl p-4 border-2 border-gray-200" data-entry="${entryCounter}">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="number" step="0.01" class="debit-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-300" placeholder="0.00" onchange="calculateTotals()">
                </div>
                
                <div class="md:col-span-2">
                    <label class="block text-sm font-semibold text-gray-700 mb-2">دائن</label>
                    <input type="number" step="0.01" class="credit-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-300" placeholder="0.00" onchange="calculateTotals()">
                </div>
                
                <div class="md:col-span-2">
                    <label class="block text-sm font-semibold text-gray-700 mb-2">البيان</label>
                    <input type="text" class="description-input w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all duration-300" placeholder="بيان...">
                </div>
