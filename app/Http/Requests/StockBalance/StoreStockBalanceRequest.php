...
class StoreStockBalanceRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return Gate::allows('create', StockBalance::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'item_id' => ['required', 'integer', 'exists:items,id', 'unique:stock_balances,item_id,NULL,id,warehouse_id,' . $this->input('warehouse_id')],
