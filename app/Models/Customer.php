...
class Customer extends Model
{
    ...
    /**
     * علاقة العميل بالتعاملات المالية (المبيعات، المقبوضات).
     *
     * @return HasMany
     */
    ...
    /**
     * علاقة العميل بالمستخدم الذي أنشأه.
     *
     * @return BelongsTo
     */
    ...
    public function calculateCurrentBalance(): float
    {
        ...
        // نفترض أن قيمة التعاملات موجبة تعني دين على العميل (مستحق للشركة) وسالبة تعني دفع من العميل.
